# LeetCode_SQL-50_Solutions
A complete collection of solutions to the **LeetCode SQL 50** study plan — one of the best resources to prepare for SQL interviews.

---

## 📌 About

In this Repo I will share my own solution for SQL 50 questions on LeetCode [LeetCode SQL 50](https://leetcode.com/studyplan/top-sql-50/) study plan. 
...
This repository is for educational purposes. Problem descriptions belong to [LeetCode](https://leetcode.com).
